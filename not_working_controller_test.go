...
import (
	...
	rtcfg "github.com/devopsext/configurator/pkg/apis/rtcfg/v1alpha1"
	"github.com/devopsext/configurator/pkg/generated/clientset/versioned/fake"
...
func newFoo(name string, replicas *int32) *rtcfg.Foo {
	return &rtcfg.Foo{
		TypeMeta: metav1.TypeMeta{APIVersion: rtcfg.SchemeGroupVersion.String()},
...
func (f *fixture) newController() (*Controller, informers.SharedInformerFactory, kubeinformers.SharedInformerFactory) {
	...
	c.genericsSynced = alwaysReady
	c.deploymentsSynced = alwaysReady
	c.recorder = &record.FakeRecorder{}

	for _, f := range f.genericLister {
...
func (f *fixture) expectUpdateFooStatusAction(foo *rtcfg.Foo) {
...
func getKey(foo *rtcfg.Foo, t *testing.T) string {
...
func TestCreatesDeployment(t *testing.T) {
	...
	f.genericLister = append(f.genericLister, foo)
